...
# 角色自动校验 Prompt（Actor-Critic 架构）
from scholarpilot.context.prompts.verification import (
    VERIFICATION_PROMPTS,
    ACTOR_CRITIC_MAP,
    POLICY_SEARCH_VERIFICATION_PROMPT,
    TOPIC_ANALYSIS_VERIFICATION_PROMPT,
    LITERATURE_SEARCH_VERIFICATION_PROMPT,
    EVIDENCE_MATRIX_VERIFICATION_PROMPT,
    SPEC_GENERATION_VERIFICATION_PROMPT,
    OUTLINE_VERIFICATION_PROMPT,
    SECTION_WRITING_VERIFICATION_PROMPT,
)
